          ...
          <List.Item key={item.title} style={{ width: '100%' }}>
            <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'flex-start', width: '100%' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                <p style={{ justifySelf: 'flex-start', marginLeft: '3%', fontFamily: 'Comic Sans MS', fontSize: 15 }}>
                  {item.content}
                </p>
                <div style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between' }}>
                  ...
                  <div style={{ display: 'flex', justifySelf: 'flex-end', alignSelf: 'flex-end', fontSize: 8 }}>
                    {dayjs(item.createdAt, 'YYYYMMDDHHmmss', 'zh-cn').format('YYYY-MM-DD HH:mm:ss')}
                  </div>
                </div>
              </div>
            </div>
