    ...
    <>
      ...
      <ul className='about-list'>
        ...
        <li>
          ...
          <a href='mailto:cuferpan@gmail.com'>1341593564@qq.com</a>
        </li>
        <li>工作地：北京</li>
        <li>码龄：3年</li>
        {/* <li>*/}
        ...
        <li>
          其他
          <ul>
            <li>常用开发工具： idea、vscode、webstorm、git、notepad++、微信开发者工具、HBuilder X</li>
            <li>熟悉的 UI 框架： antd、element-ui、layui、bootstrap</li>
